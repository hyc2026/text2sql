...
class ModelLoader:
    ...
    def load_model(self, logdir, step, allow_untrained=False, load_best=True):
        ...
        print('load model_{}'.format(last_step))
...
class DuoratAPI(object):
    ...
    def __init__(self, logdir: str, config_path: str, config_step):
        ...
        self.model = self.inferer.load_model(logdir, step=config_step)
    ...
    @staticmethod
    def parse_single2(model, item, beam_size, decode_max_time_step):
