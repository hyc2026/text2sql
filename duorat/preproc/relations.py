...
class SourceRelationsBuilder(object):
    ...
    def _qc_relations(
        ...
        # ValueError: Found more than 1 q-c matches: [ValueMatchTag(confidence=HighConfidenceMatch(), column_id='18', table_id='1', value='1901年'), ValueMatchTag(confidence=HighConfidenceMatch(), column_id='18', table_id='1', value='1901年')]
