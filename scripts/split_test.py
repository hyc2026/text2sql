...
def main(data_path, duorat_path) -> None:
    tables_json_path = "test_schema.json"
    content_json_path = 'test_content.json'
    examples_paths = ["test.json"]
...
if __name__ == '__main__':
    ...
    parser.add_argument("--duorat-path", type=str, default='./data/database_test')
