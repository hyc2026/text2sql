...
def main(data_path, duorat_path) -> None:
    tables_json_path = "db_schema_2.0.json"
    content_json_path = 'db_content_2.0.json'
    examples_paths = ["fold_2.0_3/spdb_train_2.0.json", "fold_2.0_3/spdb_val_2.0.json"]
    ...
    for examples_path in examples_paths:
        ...
        with open(os.path.join(data_path, examples_path.replace('spdb', 'gold')), "w") as write_fp:
            json.dump(payload, write_fp, indent=2, ensure_ascii=False)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--data-path", type=str, default='./data/V2.0')
    parser.add_argument("--duorat-path", type=str, default='./data/database_2.0_fold3')
